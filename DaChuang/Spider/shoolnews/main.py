...
# cmdline.execute("scrapy crawl Architecture".split()) # 力学与土木建筑学院 # 2.

# cmdline.execute("scrapy crawl HonorsCollege".split()) # 教育实验学院 # 2.

# cmdline.execute("scrapy crawl PowerandEnergy".split()) # 动力与能源学院 # 2.

# cmdline.execute("scrapy crawl NaturalandAppliedSciences".split()) # 理学院 # 2.

# cmdline.execute("scrapy crawl Software".split()) # 软件学院 # 2.
