...
class ElectricitySpider(scrapy.Spider):
    ...
    start_urls = ['http://dianzi.nwpu.edu.cn/xwgg/xyxw/xyxw.htm']
    base_url = "http://dianzi.nwpu.edu.cn/xwgg/xyxw/"
    ...
    def parse_content(self, response):
        ...
        item = response.meta
        content = ''
        plist = response.xpath('//*[@id="vsb_content"]/div')
